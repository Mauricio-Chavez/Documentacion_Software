...
<br/>
    <img src="./Imprimircolapng.png" alt="Metodo para Insertar un Animal a la Cola" width="70%">
     <br/>
...
<br/>
    <img src="./MetodoAdoptar.png" alt="Metodo para Insertar un Animal a la Cola" width="70%">
     <br/>
...
Ingresar un perrito es sencillo, el programa te pedirá cierta información como su edad,raza y nombre, al guardar cada dato deberás presionar enter para que pase a la siguiente instrucción, en la imagen se puede apreciar todo lo que la función ingresar realiza, que basicamente es el guardado de información y registro del animalito.
    <br/>
    <img src="./ingresar.png" alt="Imagen de la funcion ingresar" width="60%">
...
<br/>
<img src="./print.png" alt="Imagen Impresion de lista de animalitos" width="70%">
...
<br/>
<img src="./adopcion.png" alt="Imagen de la Adopcion de un Animalito" width="70%">
...
<br/>
<img src="./Salir.png" alt="Imagen de Finalizacion del programa" width="70%">
